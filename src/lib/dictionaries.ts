...
export const dictionaries = {
  en: {
    ...
    home: {
      eyebrow: "The 5-Element Roulette System  ·  五行轮盘系统",
      heroTitle1: "Play Longer.",
      heroTitle2: "Play Smarter.",
      heroTitle3: "Play Together.",
      heroSub:
        "LayFive is NOT a system to beat the casino. It is a structured way for cruise players to make their bankroll last, earn casino comps, and enjoy roulette as a social game — without losing control.",
      ctaPrimary: "Watch Video 1 (Free)",
      ctaSecondary: "Open the Tracker",
      elementsTitle: "Five Layouts. One System.",
      elementsBody:
        "Each layout covers 18 numbers using 15 small chips — twelve straight-up bets and three split bets. Pick one element per session, follow your discipline rules, and let the casino pay for your next vacation.",
      ...
      curriculumBody:
        "Six short videos walk you through the entire system, from why casinos give free cruises to how to manage your bankroll across a full session. Every video is free, no signup needed.",
      videos: [
        { n: 1, title: "Cruise Roulette: Not to Win — But to Play Longer & Get Free Cruises" },
        { n: 2, title: "The Five Element Layouts — Metal, Wood, Water, Fire, Earth" },
        { n: 3, title: "What Coverage Really Means (and What It Does Not)" },
        { n: 4, title: "Bankroll Math — Why 10 Full Bets Is the Right Starting Stack" },
        { n: 5, title: "Walk-Away Rules — Up 50%, Down 100%, or 100 Spins" },
        { n: 6, title: "Group Play — Five Friends, Five Layouts, One Table" },
      ],
