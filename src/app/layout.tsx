        ...
        <header className="border-b border-neutral-800 bg-neutral-950/80 backdrop-blur sticky top-0 z-50">
          <nav className="mx-auto max-w-6xl flex items-center justify-between px-6 py-4">
            ...
            <div className="hidden md:flex items-center gap-6 text-sm text-neutral-300">
              ...
              <a href="https://lymx4kl.github.io/layfive-app/" target="_blank" rel="noopener noreferrer" className="hover:text-amber-400">Open Tracker</a>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="https://lymx4kl.github.io/layfive-app/" target="_blank" rel="noopener noreferrer" className="hover:text-amber-400">Tracker</a></li>
                </ul>
              </div>
              <div>
